...
Play.pauseGame = function() {
    ...
    if (game.paused == true && this.pauseBg.visible == false) {} else {
...
Play.create = function() {
    ...
    // "Inventory" text
    this.invTitle = game.add.text(
        game.camera.width / 2,
        game.camera.height * 0.125 + 25,
        'Inventory'
    );
    ...
    // "Currency" text
    this.currencyText = game.add.text(
        game.camera.width / 4 + 10,
    ...
    // controls
    this.controlText = game.add.text(game.camera.width / 2, 600,
        'Up:    W   Left:   A\n'
        +'Down:  S   Right:  D\n'
